...
class LIF(Neuron):
    def __init__(self, resting=-70.0, threshold=-55.0, leak=0.01, peak=40.0, refractory_overshoot=-80.0,
                 refractory_duration=2.0, synaptic_input=0.0, vm_init=None):
        ...
        self.Vm = vm_init if vm_init is not None else resting
